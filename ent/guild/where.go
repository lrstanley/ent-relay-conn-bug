...
func Region(v string) predicate.Guild {
	return predicate.Guild(func(s *sql.Selector) {
...
func RegionEQ(v string) predicate.Guild {
	return predicate.Guild(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldRegion), v))
	})
}
...
func RegionNEQ(v string) predicate.Guild {
	return predicate.Guild(func(s *sql.Selector) {
...
func RegionIn(vs ...string) predicate.Guild {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func RegionNotIn(vs ...string) predicate.Guild {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func RegionGT(v string) predicate.Guild {
	return predicate.Guild(func(s *sql.Selector) {
...
func RegionGTE(v string) predicate.Guild {
	return predicate.Guild(func(s *sql.Selector) {
...
func RegionLT(v string) predicate.Guild {
	return predicate.Guild(func(s *sql.Selector) {
...
func RegionLTE(v string) predicate.Guild {
	return predicate.Guild(func(s *sql.Selector) {
...
func RegionContains(v string) predicate.Guild {
	return predicate.Guild(func(s *sql.Selector) {
...
func RegionHasPrefix(v string) predicate.Guild {
	return predicate.Guild(func(s *sql.Selector) {
...
func RegionHasSuffix(v string) predicate.Guild {
	return predicate.Guild(func(s *sql.Selector) {
...
func RegionIsNil() predicate.Guild {
	return predicate.Guild(func(s *sql.Selector) {
...
func RegionNotNil() predicate.Guild {
	return predicate.Guild(func(s *sql.Selector) {
...
func RegionEqualFold(v string) predicate.Guild {
	return predicate.Guild(func(s *sql.Selector) {
...
func RegionContainsFold(v string) predicate.Guild {
	return predicate.Guild(func(s *sql.Selector) {
...
// HasGuildSettings applies the HasEdge predicate on the "guild_settings" edge.
func HasGuildSettings() predicate.Guild {
	return predicate.Guild(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(GuildSettingsTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2O, false, GuildSettingsTable, GuildSettingsColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasGuildSettingsWith applies the HasEdge predicate on the "guild_settings" edge with a given conditions (other predicates).
func HasGuildSettingsWith(preds ...predicate.GuildSettings) predicate.Guild {
	return predicate.Guild(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(GuildSettingsInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2O, false, GuildSettingsTable, GuildSettingsColumn),
		)
